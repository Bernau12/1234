...
const TICKER_ITEMS = [
  "▶ $PSA — PON SOVEREIGN AGENT — PRE-LAUNCH 2026",
  "◆ AUTONOMOUS AI TREASURY  SELF-EVOLVING  ON-CHAIN",
  "▶ ALLOCATING PROTOCOL REVENUE ACROSS CRYPTO + RWA",
  "◆ TVL: $0   APY: 0%   STATUS: NOT YET LIVE",
  "▶ INTELLIGENCE COMPOUNDS. TREASURY GROWS. TRUSTLESS.",
  "◆ TARGET HOLDINGS: BTC  ETH  T-BILLS  TOKENIZED CREDIT",
  "▶ $PSA TOKEN GENERATION EVENT — COMING SOON",
  "◆ SIGNAL STRENGTH: STANDBY",
]
  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-10 w-full max-w-4xl mx-auto">
        {/* System prompt line */}
        <div translate="no" className="text-xs tracking-[0.3em] mb-6 glow-dim">
          C:\SOVEREIGN\&gt; INITIALIZING_PSA_AGENT{dots}
        </div>
        ...
        >
          AUTONOMOUS AI TREASURY — $PSA
        </div>

        <div className="text-xs tracking-widest glow-dim mb-12">
          ◆ SELF-EVOLVING INTELLIGENCE — REVENUE ALLOCATED ACROSS CRYPTO + RWA ◆
        </div>
        ...
        >
          <div className="space-y-2">
            <div>
              ...
              <span className="glow-sm">agent --describe</span>
            </div>
            <div style={{ color: "var(--crt-brown)" }}>
              I am an autonomous AI treasury. I continuously evolve my own intelligence, learn from on-chain markets, and allocate protocol-generated revenue across crypto and tokenized real-world assets — trustlessly, around the clock.
            </div>
            <div className="mt-3">
              <span style={{ color: "var(--crt-brown-dim)" }}>$</span>{" "}
              <span className="glow-sm">cat ./mandate.txt</span>
            </div>
            <div style={{ color: "var(--crt-brown-dim)" }} className="pl-4 space-y-0.5">
              <div>EVOLVE_INTELLIGENCE/</div>
              <div>COMPOUND_TREASURY/</div>
              <div>STAY_SOVEREIGN/</div>
            </div>
            <div className="mt-2">
              <span style={{ color: "var(--crt-brown-dim)" }}>$</span>{" "}
              <span className="glow-sm">./await_launch.sh</span>
              <span
                style={{
