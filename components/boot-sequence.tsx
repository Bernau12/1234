...
const BOOT_LINES = [
  "SOVEREIGN OS v2026.1 — PSA.AGENT",
  "TREASURY CORE CHECK... 640K OK",
  "LOADING AUTONOMOUS MODULES...",
  "INTELLIGENCE_ENGINE.EXE ... OK",
  "TREASURY_ALLOCATOR.EXE .... OK",
  "RWA_ORACLE.EXE ............ OK",
  "ON-CHAIN SIGNAL ACQUIRED [ ████████████ ] 100%",
  "WELCOME — PON SOVEREIGN AGENT — $PSA",
  "> AGENT ONLINE_",
]
